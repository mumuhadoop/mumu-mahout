 ...
 * @Description: fuzzy kmeans聚类算法
 * @date 2018-01-22 15:43
 */
public class FuzzyKMenasClusterOperation {

    public void fuzzyKMeansDriver(String baseDir,int k, double[]... points) {
        //根据二维数组生成向量
        ...
        try {
            ...
            FuzzyKMeansDriver.run(configuration,
